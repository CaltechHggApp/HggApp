...
public :
   ...
   Int_t           Photon_mother[kMaxPhoton];   //[Photon_]
   ...
   Int_t           PhotonPFCiC_mother[kMaxPhotonPFCiC];   //[PhotonPFCiC_]
   ...
   Int_t           PhotonCiC_mother[kMaxPhotonCiC];   //[PhotonCiC_]
   ...
   HggOutputReader2(TTree *tree=0);
   virtual ~HggOutputReader2();
...
#ifdef HggOutputReader2_cxx
HggOutputReader2::HggOutputReader2(TTree *tree) : fChain(0) 
{
...
HggOutputReader2::~HggOutputReader2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t HggOutputReader2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t HggOutputReader2::LoadTree(Long64_t entry)
{
...
void HggOutputReader2::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Photon.mother", Photon_mother, &b_Photon_mother);
   ...
   fChain->SetBranchAddress("PhotonPFCiC.mother", PhotonPFCiC_mother, &b_PhotonPFCiC_mother);
   ...
   fChain->SetBranchAddress("PhotonCiC.mother", PhotonCiC_mother, &b_PhotonCiC_mother);
...
Bool_t HggOutputReader2::Notify()
{
...
void HggOutputReader2::Show(Long64_t entry)
{
...
Int_t HggOutputReader2::Cut(Long64_t entry)
{
...
#endif // #ifdef HggOutputReader2_cxx
