...
// Wed Feb 19 17:33:50 2014 by ROOT version 5.34/07
// from TTree SusyHggTree/
// found on file: /home/amott/raid4/DoublePhoton_22Jan2013_Run2012B.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Int_t           nSusyPart;
   Float_t         mSusyPart[200];   //[nSusyPart]
   Int_t           idSusyPart[200];   //[nSusyPart]
   Float_t         m22;
   Float_t         m23;
   Float_t         m24;
   Float_t         m25;
...
SusyHggTree::SusyHggTree(TString fileName):fChain(0) {
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/amott/raid4/DoublePhoton_22Jan2013_Run2012B.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/amott/raid4/DoublePhoton_22Jan2013_Run2012B.root");
      }
