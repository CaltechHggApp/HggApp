...
void make1DLimit(TString combine_dir,TString type= "WH",bool blind=true){
  ...
  TGraph obser( (500-125)/25 );
  TGraph graph( (500-125)/25 );
  TGraphAsymmErrors error( (500-125)/25 );

  TGraph obser_r( (500-125)/25 );
  TGraph graph_r( (500-125)/25 );
  TGraphAsymmErrors error_r( (500-125)/25 );
  ...
  for(int m=125;m<500;m+=25) {
    ...
    error_r.GetXaxis()->SetTitle("m_{chargino}");
